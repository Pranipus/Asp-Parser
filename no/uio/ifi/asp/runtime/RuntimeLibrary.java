        ...
        assign("print", new RuntimeFunc("print"){
          ...
          assign("int", new RuntimeFunc("int"){
            ...
            AspSyntax where){
              ...
              if (v instanceof RuntimeStringValue || v instanceof RuntimeIntValue){
                return new RuntimeIntValue(v.getIntValue("int()", where));
              } else if (v instanceof RuntimeIntValue){
                return v;
              } else {
                RuntimeValue.runtimeError("Illegal parameter type for int().", where);
                return null;
              }
            }});
          ...
          assign("float", new RuntimeFunc("float"){
            ...
            AspSyntax where){
              ...
              if(v instanceof RuntimeStringValue || v instanceof RuntimeIntValue){
                ...
                RuntimeValue.runtimeError("Illegal parameter type for float().", where);
                return null;
              }
            }});
            ...
            assign("input", new RuntimeFunc("input"){
              ...
              AspSyntax where){
                ...
                if(v instanceof RuntimeStringValue){
                  RuntimeStringValue strng = (RuntimeStringValue) v;
                  System.out.print(strng.toString());
                  return new RuntimeStringValue(keyboard.next());
                }else{
                  RuntimeValue.runtimeError("Illegal parameter type for input().", where);
                  return null;
                }
              }});
